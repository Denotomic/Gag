...
import CarWorkshop from "./pages/CarWorkshop";
import AutoRepair from "./pages/AutoRepir";
  ...
  return (
    <Routes>
      <Route path="/" element={<Main />}>
        ...
        <Route path="/car-workshop" element={<CarWorkshop />}></Route>
        <Route path="/auto-repair" element={<AutoRepair />}></Route>
