...
const footerDataArray = [
  {
    ...
    dataAosDelay: "0",
    phone: "+254 725 990 729" + " " + "+254 722 124 629",
    desp: "We specialize in the repair and maintenance of German vehicles, including BMW, Mercedes-Benz, Audi, and Volkswagen.",
  },
  {
  ...
  },
  {
    ...
    dataAosDelay: "150",
    address: "We are located along nyasa road off Jogoo road next to Makadara law court.",
    email: "info@germanautogarage.co.ke",
  },
];
        ...
        <div className="container">
          ...
          <div className="copy-right">
            <p className="title  text-hover-animaiton">
              German Auto Garage Copyright 2026, All Right reserved
            </p>
