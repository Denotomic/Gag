...
const sliderDataThree = [
  {
    ...
    video: "/assets/video/hero-bg-video.mp4",
    url: "/appointment",
  },
  {
    id: 2,
    ...
    maintitle: "Services",
    desp: "Our skilled team of certified technicians is here to provide top-notch car repair and auto services to ensure your vehicle performs at its best. Our skilled team of certified technicians.",
    video: "/assets/video/hero-bg-video-2.mp4",
    url: "/appointment",
  },
];

const AutoRepairHeroSlider = () => {
  const swiperRef = useRef(null);

  return (
    <section className="ak-slider ak-slider-hero-three">
      <Swiper
        speed={1000}
        loop={true}
        parallax={true}
...
export default AutoRepairHeroSlider;
