...
const PricingAutoRepair = () => {
  return (
    <>
      <div class="ak-height-125 ak-height-lg-50"></div>
      <div className="ak-bg">
        <div className="container">
          ...
          <div className="pricing type-two">
            {pricingData.map((plan) => (
              <div
                key={plan.id}
                className="pricing-card style-two"
                data-aos="fade-up"
                data-aos-delay={plan.delay}
              >
                <div className="pricing-heading">
                  <p className="title">{plan.title}</p>
                  <h2 className="discount-price">{plan.discountPrice}</h2>
                  <h5 className="main-price">{plan.mainPrice}</h5>
                </div>
                  ...
                  <span>
                    ...
                    <span>
                      <svg
                        ...
                        fill="none"
                      >
                        <g clipPath={`url(#clip0_147_83${plan.id})`}>
                          <path
                        ...
                        <defs>
                          <clipPath id={`clip0_147_83${plan.id}`}>
                            <rect
                              width="16"
                              height="16"
                              fill="white"
...
export default PricingAutoRepair;
