          ...
          <div className="sidebar width-none">
            <div className="services-content">
              <SectionHeading
                ...
                desp={
                  "Our team is committed to doing the job right the first time, using quality parts, careful attention to detail, and trusted experience you can rely on. When you choose us, you’re choosing a garage dedicated to lasting results and customer confidence."
                }
              />
