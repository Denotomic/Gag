...
const tabContents = [
  {
    title: "Mission",
    description:
      "To provide specialized, reliable, and high-quality automotive services. Ensuring the highest standards of performance, safety, and aesthetic appeal.",
  },
  {
    title: "Vision",
    description:
      "To be East Africas's leading provider of specialized German vehicle services, recognized for our technical expertise, trusted customer relationships, and unmatched service quality.",
  },
  {
    title: "History",
    description:
