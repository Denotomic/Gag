...
const AppointmentForm = ({ styleTwo }) => {
  ...
  return (
    <div className="container">
      ...
      <div className={`contact-content ${styleTwo ? "style-two" : ""}`}>
        <div
        ...
        >
          ...
          <p>
            Book your vehicle service quickly and easily by completing the 
            appointment form below. Please include a short description of the issues, 
            warning lights, performance concerns, or repairs needed.
          </p>
          {styleTwo && (
            <>
                    ...
                    <span>
                      ...
                      >
                        <g clip-path="url(#clip0_736_3019)">
                          ...
                          />
                          <path
                            d="M11.833 10.0596L10.1933 12.1092H11.833V10.0596Z"
                            fill="#FF3D24"
                          />
                          <path
        ...
        {!styleTwo && <div className="ak-height-25 ak-height-lg-20"></div>}

        <div
          className={`contact-form ${styleTwo ? "form-bg" : ""}`}
          data-aos="fade-up"
          data-aos-delay="750"
        >
          <div id="ak-alert"></div>
