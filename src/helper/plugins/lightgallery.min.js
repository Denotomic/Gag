            ...
            (s.prototype.init = function () {
              ...
              (s.prototype.structure = function () {
                ...
                for (
                  ...
                  e += '<div className="lg-item"></div>';
                if (
                  (this.s.controls &&
                    this.items.length > 1 &&
                    (t =
                      '<div className="lg-actions"><button type="button" aria-label="Previous slide" className="lg-prev lg-icon">' +
                      this.s.prevHtml +
                      '</button><button type="button" aria-label="Next slide" className="lg-next lg-icon">' +
                      this.s.nextHtml +
                      "</button></div>"),
                  ".lg-sub-html" === this.s.appendSubHtmlTo &&
                    (i =
                      '<div role="status" aria-live="polite" className="lg-sub-html"></div>'),
                  (o =
                    ...
                    (this.s.ariaDescribedby
                      ...
                      : "") +
                    ' role="dialog" className="lg-outer ' +
                    this.s.addClass +
                    " " +
                    this.s.startClass +
                    '"><div className="lg" style="width:' +
                    this.s.width +
                    "; height:" +
                    this.s.height +
                    '"><div className="lg-inner">' +
                    e +
                    '</div><div className="lg-toolbar lg-group"><button type="button" aria-label="Close gallery" className="lg-close lg-icon"></button></div>' +
                    t +
                    i +
                    "</div></div>"),
                ...
                setTimeout(function () {
                  ...
                  this.s.download &&
                    this.outer
                      ...
                      .insertAdjacentHTML(
                        "beforeend",
                        '<a id="lg-download" aria-label="Download" target="_blank" download className="lg-download lg-icon"></a>'
                      ),
                  (this.prevScrollTop =
                ...
                if (!l.default.hasClass(i.___slide[e], "lg-loaded")) {
                  if (h)
                    i.___slide[e].insertAdjacentHTML(
                      "afterbegin",
                      '<div className="lg-video-cont" style="max-width:' +
                        i.s.iframeMaxWidth +
                        '"><div className="lg-video"><iframe className="lg-object" frameborder="0" src="' +
                        a +
                    ...
                    (p =
                      ...
                      i.___slide[e].insertAdjacentHTML(
                        ...
                        '<div className="lg-video-cont ' +
                          p +
                          ' "><div className="lg-video"><span className="lg-video-play"></span><img className="lg-object lg-has-poster" src="' +
                          d +
                          '" /></div></div>'
                      );
                  } else
                    m
                      ? (i.___slide[e].insertAdjacentHTML(
                          "beforeend",
                          '<div className="lg-video-cont "><div className="lg-video"></div></div>'
                        ),
                      ...
                      : ((g = g ? 'alt="' + g + '"' : ""),
                        i.___slide[e].insertAdjacentHTML(
                          "beforeend",
                          '<div className="lg-img-wrap"><img className="lg-object lg-image" ' +
                            g +
                            ' src="' +
                            a +
                            '" /></div>'
